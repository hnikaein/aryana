...
all:$(PROG) aryana convert-genomes align-bs methyl-extract BisSimul SamAnalyzer
...
clean:
		rm -f gmon.out *.o a.out $(PROG) *~ *.a aryana align_bs methyl_extract convert_genomes BisSimul SamAnalyzer 
gen:
