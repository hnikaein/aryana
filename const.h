...
#define MAX_READ_NAME_LENGTH 10000
#define MAX_CHR_NAME_LENGTH 10000
#define MAX_SAM_LINE_LENGTH (3*(MAX_READ_LENGTH)+(MAX_READ_NAME_LENGTH)+(MAX_CHR_NAME_LENGTH)+1000)
