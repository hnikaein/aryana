...
void create_cigar(aryana_args *options, hash_element *best, char *cigar, int len, const ubyte_t *seq, const ubyte_t *qual, uint64_t seq_len,int **d, unsigned char **arr, char * tmp_cigar, penalty_t * penalty, uint64_t * reference, ignore_mismatch_t ignore);
